...
import { useEditStockForm } from './edit-stock-form.effect';
import { EditStockFormProp } from './edit-stock-form.props';
import { InputMolecule } from '../../atoms/input/input.molecule';
import { SelectMolecule } from '../../atoms/select/select.molecule';

export const EditStockFormOrganism = ({ stock, stores, items }: EditStockFormProp) => {
  const { setData, data, processing, errors, handleSubmit } = useEditStockForm(stock);
    ...
    <section aria-labelledby="section-1-title">
      <div className="rounded-lg bg-white overflow-hidden shadow">
        <form>
          <div className="p-8">
            <div>
              <h2 className="header">Edit stock</h2>
              <p className="mt-1 text">Please update form below to modify existing stock.</p>
            </div>
