...
import { useCreateTagForm } from './create-tag-form.effect';

export const CreateTagFormOrganism = () => {
  const { setData, data, processing, errors, handleSubmit } = useCreateTagForm();
    ...
    <section aria-labelledby="section-1-title">
      <div className="rounded-lg bg-white overflow-hidden shadow">
        <form>
          <div className="p-8">
            <div>
              <h2 className="header">Create tag</h2>
              <p className="mt-1 text">Please fill form below to create new tag.</p>
            </div>
