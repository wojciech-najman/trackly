...
import { EditStoreFormProps } from './edit-store-form.props';
import { TextareaMolecule } from '../../atoms/textarea/textarea.molecule';
import { useEditStoreForm } from './edit-store-form.effect';

export const EditStoreFormOrganism = (props: EditStoreFormProps) => {
  const { setData, data, processing, errors, handleSubmit } = useEditStoreForm(props.store);
    ...
    <section aria-labelledby="section-1-title">
      <div className="rounded-lg bg-white overflow-hidden shadow">
        <form>
          <div className="p-8">
            <div>
              <h2 className="header">Edit store</h2>
              <p className="mt-1 text">Please update form below to modify existing store.</p>
            </div>
